  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {view !== "today" && (
          <div className="flex items-center gap-0.5 rounded-lg border p-0.5">
            <Button size="sm" variant={!teamScope ? "secondary" : "ghost"} aria-pressed={!teamScope} onClick={() => setTeamScope(false)}>
              My work
            </Button>
            <Button size="sm" variant={teamScope ? "secondary" : "ghost"} aria-pressed={teamScope} onClick={() => setTeamScope(true)}>
              Team
            </Button>
          </div>
        )}
      ...
      {(view === "week" || view === "month") &&
        (() => {
          const scheduleTasks = filterTasks(teamScope ? teamTasks : tasks, { ...filters, status: "all" });
          return (
